...
website = 'localhost'
sox.connect ( (website, 80) )

cli2srv = ( tlspool.PIOF_STARTTLS_LOCALROLE_CLIENT | tlspool.PIOF_STARTTLS_REMOTEROLE_SERVER )
cnx = tlspool.Connection (sox, service='http', flags=cli2srv)

cnx.tlsdata.localid='testcli@tlspool.arpa2.lab'
cnx.tlsdata.remoteid='testsrv@tlspool.arpa2.lab'
